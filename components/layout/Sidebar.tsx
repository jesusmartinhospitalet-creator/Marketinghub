    ...
    >
        ...
        {clients.length > 0 && (
          <>
            ...
            {clients.map(client => {
              ...
              return (
                <ClientItem key={client.id} client={client} isActive={isActive} />
              )
            })}
          </>
        )}
      ...
      <div className="p-3 border-t border-[var(--border)]">
        <button
          ...
          onClick={() => {/* modal: crear cliente – fase siguiente */}}
        >
          + Nuevo cliente
        </button>
      </div>
...
function ClientItem({ client, isActive }: { client: SidebarClient; isActive: boolean }) {
        ...
        {hovered && (
          <div className="flex gap-1" onClick={e => e.preventDefault()}>
            <button
              ...
              onClick={e => { e.preventDefault(); /* editar cliente */ }}
              title="Editar"
            >
              ✏️
            </button>
